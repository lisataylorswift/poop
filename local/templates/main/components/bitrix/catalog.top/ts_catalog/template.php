...
<?php 
// echo '<pre>';
// print_r(value: $arResult);
// echo '</pre>'
?>


    <a href="/catalog/" class="shop-all">Shop All</a>
		    <div class="section-top">
                
			      <div class="popular-products__titles titles">
				        <h2 class="h3 popular-products__title title">The Autumn Chill Collection</h2>
			      </div>
            </div>
...
?>
        ...
        <div class="products">
            ...
            <div class="collection">
                ...
                <img src="local/templates/main/images/scarf.png" alt="THE AUTUMN CHILL COLLECTION">
                <h3 class="text-overlay">THE AUTUMN CHILL COLLECTION</h3>
                </div>
            </div>
            ...
            <?php foreach ($arResult["ITEMS"][0] as $item): ?>
                <div class="product">
                    ...
                    <p class="price">$<?= $item["MIN_PRICE"]["VALUE"] ?></p>
